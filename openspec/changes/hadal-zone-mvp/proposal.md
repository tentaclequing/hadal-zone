...
People facing political repression, forced displacement, and systemic threats need access to practical survival knowledge — how to protest safely, leave a country, obtain a visa, share skills, know their legal rights. This information exists but is scattered, fragile, and easily censored. This information exists but is scattered across many sources and often hard to find when you need it most.

hadal-zone creates a decentralised, resilient library dedicated to resistance and mutual aid resources. Named after the deepest, most unreachable zone of the ocean, the platform ensures these documents stay online and accessible to everyone — including people with disabilities — regardless of who tries to remove them.
...
- IPFS pinning (via Web3.Storage) for resilient document storage
...
- `ipfs-resilience`: IPFS pinning via Web3.Storage for resilient document distribution, with instructions for community mirroring
